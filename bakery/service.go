...
type NewServiceParams struct {
	...
	// RootKeyStore is used to store macaroon information. If this
...
// lookup uses the given store to look up macaroon root keys
// get root keys and ids.
//
// When NewMacaroon is called on the returned Service,
// is must always be called with an empty id and rootKey.
