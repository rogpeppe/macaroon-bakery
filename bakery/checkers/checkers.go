...
// Func is the type of a function used by Checker to check a caveat.
// The cond will hold the condition that was registered and
// the argument any additional caveat argument text.
...
// if the condition has been registered twice.
func (c *Checker) Register(cond, uri string, check Func) {
	...
	fullCond := WithPrefix(prefix, cond)
