...
// NewFallbackStorage returns a RootKeyStorage implementation
// that uses s0 as primary storage, but will fall back to getting
// root keys from s1 if an id in s0 cannot be found.
//
// RootKey will always return root keys from s0.
//func NewFallbackStorage(s0, s1 RootKeyStorage) RootKeyStorage {
//}
